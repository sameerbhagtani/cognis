...
folderRoutes.patch("/:folderId", requireFolderAccess(WRITE_ROLES), folderController.updateFolder);
folderRoutes.delete("/:folderId", requireFolderAccess(WRITE_ROLES), folderController.deleteFolder);
folderRoutes.post(
    "/:folderId/restore",
